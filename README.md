...
4.  **آیدی عددی تلگرام:** شما باید `CHAT_ID` عددی خود را بدانید. (می‌توانید آن را از ربات‌هایی مانند `@userinfobot` دریافت کنید).
...
**⚠️ مهم: هرگز این اطلاعات را به صورت عمومی یا در گیت‌هاب به اشتراک نگذارید.**

## اجرای اسکریپت

پس از نصب و تنظیم، ترمینال را در پوشه پروژه باز کرده و اسکریپت را با دستور زیر اجرا کنید:
