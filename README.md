...
pip-review --auto
pip install MetaTrader5 "python-telegram-bot==13.15" pytz python-dateutil psutil matplotlib numpy scipy arabic_reshaper python-bidi flask colorlog aiosmtpd pillow
```
...
## نصب اندیکاتور برای دریافت آلرت
اندیکاتور موجود در پوشه را در متاتریدر خود نصب کنید(نحوه ی نصب گوگل شود)

تنظیمات متاتریدر و تیک ها رو هم طبق تصویر درست کنید(یوزر و پسورد یکی هستن)


<img width="622" height="404" alt="bot_script smtp" src="https://github.com/user-attachments/assets/aaa8dbf4-3ffd-4a49-8e13-23eb232c9b1e" />

<img width="753" height="528" alt="image" src="https://github.com/user-attachments/assets/f8906538-c065-4a0c-b8ea-25f201e074c0" />


**تنظیمات اندیکاتور**: اندیکاتور رو میتونید روی چندین چارت و چندین نماد اجرا کنید اما در تنظیمات اندیکاتور، برای یکی از اندیکاتور ها گزینه ی `master` را `true` کنید و باقی `false`
## نحوه استفاده
