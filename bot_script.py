...
def format_position_closed(deal, original_order_comment, initial_volume, is_complete_close, total_position_profit, total_sign):
                ...
                if new_deals:
                    for deal in new_deals:
                        ...
                        if deal.entry == mt5.DEAL_ENTRY_IN:
                            ...
                            if position_deals:
                                for opening_deal in position_deals:
                                    ...
                                    if opening_deal.entry == mt5.DEAL_ENTRY_OUT:
                                        ...
                                        # سود خالص تمام معاملات خروجی را جمع می‌زنیم
                            ...
                            msg = format_position_closed(deal, original_comment, initial_volume, is_complete_close, total_position_profit, total_sign)
                            send_telegram(msg)
